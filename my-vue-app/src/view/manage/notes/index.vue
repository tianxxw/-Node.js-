  ...
  <template>
   <div>
    <el-table :data="goods.slice((currentPage-1)*pageSize,currentPage*pageSize)" border @row-click="viewDetails" >
     ...
     <el-table-column prop="time" label="出发时间" width="150" />
     <el-table-column prop="days" label="持续时间" width="90" >
     </el-table-column>
     <el-table-column prop="quantity" label="图片量" width="100" />
     <el-table-column prop="look" label="观看人数" width="90" />
     <el-table-column prop="like" label="喜欢人数" width="90" />
     <el-table-column prop="comment" label="评论量" width="70" />
